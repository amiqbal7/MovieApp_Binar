...
import { AiFillHeart, AiFillCodeSandboxCircle } from "react-icons/ai";
        ...
        {movies.slice(0, 6).map((movie) => (
          ...
          >
            <div className="">
              ...
              />
              <div className="">
                <div className="absolute xl:pl-40 sm:pl-32 linear-bg py-36 sm:py-36 md:py-56 lg:py-72 xl:py-[350px] pb-[1200px] pl-12 top-0 right-0 left-0 flex flex-col md:gap-3 lg:gap-4 gap-1 justify-center">
